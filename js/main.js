         ...
         .add({
            ...
            complete: function () {
               ...
               anime({
                  ...
                  easing: 'easeInOutCubic',
                  scaleX:
                     direction === 'lr' || direction === 'rl' ? [1, 0] : [1, 1],
                  scaleY:
                     direction === 'tb' || direction === 'bt' ? [1, 0] : [1, 1],
                  complete: function () {
            ...
            sliderOptions['on'] = {
               init: function () {
                  ...
                  let activeIndex = this.activeIndex,
                     ...
                     fancy_el =
                        current_slide.querySelectorAll('[data-fancy-text]');
                           ...
                           if (
                              ...
                              if (options.el) {
                                 for (
                                    ...
                                    element.children[i].style.transition =
                                       'none';
   ...
   function setBottomOverLayerPosition(delay) {
      if ($('.overlap-section-bottom').length > 0 && getWindowWidth() >= 768) {
         $('.overlap-section-bottom').each(function () {
            var _this = $(this),
               timeOut =
                  _this.find('.instafeed-wrapper').length > 0 ? delay : 10;
            setTimeout(function () {
               _this.imagesLoaded(function () {
            ...
            if (stackItems.length) {
               ...
               for (let i = 0; i < stackItems.length - 1; i++) {
                  ...
                  if (windowScrollTop - stackTopPosition > stackBoxHeight) {
                     var yMove =
                        windowScrollTop - stackTopPosition - stackBoxHeight;
